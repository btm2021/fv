...
function TradingJournalModal({
  ...
  const monthName = currentDate.toLocaleString('vi-VN', {
    month: 'long',
    year: 'numeric'
  });
  ...
  const fullJsonReport = useMemo(() => {
    return {
      ...
      daily_calendar_breakdown: calendarDays.filter(d => d.day && d.trades.length > 0).map(d => ({
        date: d.dateKey,
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-50 bg-[#090D16]/95 backdrop-blur-md flex flex-col overflow-hidden font-sans text-xs text-slate-200"
  }, /*#__PURE__*/React.createElement("header", {
    className: "h-14 px-4 md:px-6 border-b border-binance-border bg-[#0D111C] flex items-center justify-between shrink-0 shadow-lg z-20"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-extrabold text-sm md:text-base text-white tracking-wide flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", null, "TRADING JOURNAL & PERFORMANCE CALENDAR"), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] bg-binance-yellow/20 text-binance-yellow px-2 py-0.5 rounded font-mono font-bold border border-binance-yellow/30"
  }, "PRO FORENSICS")), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400 font-mono hidden sm:inline"
  }, "Nhật ký giao dịch, phân tích PnL theo lịch & xuất dữ liệu JSON"))), /*#__PURE__*/React.createElement("div", {
    className: "hidden lg:flex items-center gap-2 pl-3 border-l border-binance-border font-mono text-[11px]"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400"
  }, "Net PnL:"), /*#__PURE__*/React.createElement("b", {
    className: `font-bold ${stats.netPnl >= 0 ? 'text-binance-green' : 'text-binance-red'}`
  }, stats.netPnl >= 0 ? '+' : '', "$", formatPrice(stats.netPnl), " USD"), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-600"
  }, "•"), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400"
  }, "Win Rate:"), /*#__PURE__*/React.createElement("b", {
    className: "text-binance-yellow font-bold"
  }, stats.winRate.toFixed(1), "%"), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-600"
  }, "•"), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400"
  ...
  }, "Xuất Báo Cáo JSON"), /*#__PURE__*/React.createElement("span", {
    className: "md:hidden"
  ...
  }, /*#__PURE__*/React.createElement("span", null, copiedToast ? '✅' : '📋'), /*#__PURE__*/React.createElement("span", {
    className: "hidden md:inline"
  }, copiedToast ? 'Đã Copy!' : 'Copy JSON')), /*#__PURE__*/React.createElement("button", {
    ...
    className: "p-3.5 bg-binance-panel border border-binance-border rounded-xl shadow flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-slate-400 text-[10px] font-bold uppercase tracking-wider"
  }, /*#__PURE__*/React.createElement("span", null, "TỔNG LÃI/LỖ RÒNG"), /*#__PURE__*/React.createElement("span", null, "💵")), /*#__PURE__*/React.createElement("div", {
    className: "my-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: `text-lg md:text-xl font-black ${stats.netPnl >= 0 ? 'text-binance-green' : 'text-binance-red'}`
  }, stats.netPnl >= 0 ? '+' : '', "$", formatPrice(stats.netPnl)), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400 block mt-0.5"
  }, "USD Thực Nhận")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-[10px] pt-1.5 border-t border-binance-border/60"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-binance-green"
  }, "+", formatPrice(stats.totalGain)), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-red"
  }, "-", formatPrice(stats.totalLoss)))), /*#__PURE__*/React.createElement("div", {
    className: "p-3.5 bg-binance-panel border border-binance-border rounded-xl shadow flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-slate-400 text-[10px] font-bold uppercase tracking-wider"
  }, /*#__PURE__*/React.createElement("span", null, "TỈ LỆ THẮNG (WIN RATE)"), /*#__PURE__*/React.createElement("span", null, "🎯")), /*#__PURE__*/React.createElement("div", {
    className: "my-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-lg md:text-xl font-black text-binance-yellow"
  }, stats.winRate.toFixed(1), "%"), /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-slate-800 h-1.5 rounded-full overflow-hidden mt-1.5 flex"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-binance-green h-full",
    style: {
      width: `${stats.winRate}%`
    }
  }), /*#__PURE__*/React.createElement("div", {
    className: "bg-binance-red h-full",
    style: {
      width: `${100 - stats.winRate}%`
    }
  }))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-[10px] pt-1.5 border-t border-binance-border/60 text-slate-300"
  }, /*#__PURE__*/React.createElement("span", null, "Thắng: ", /*#__PURE__*/React.createElement("b", {
    className: "text-binance-green"
  }, stats.wins)), /*#__PURE__*/React.createElement("span", null, "Thua: ", /*#__PURE__*/React.createElement("b", {
    className: "text-binance-red"
  }, stats.losses)))), /*#__PURE__*/React.createElement("div", {
    className: "p-3.5 bg-binance-panel border border-binance-border rounded-xl shadow flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-slate-400 text-[10px] font-bold uppercase tracking-wider"
  }, /*#__PURE__*/React.createElement("span", null, "HỆ SỐ LỢI NHUẬN (PF)"), /*#__PURE__*/React.createElement("span", null, "⚖️")), /*#__PURE__*/React.createElement("div", {
    className: "my-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-lg md:text-xl font-black text-white"
  }, stats.profitFactor.toFixed(2)), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400 block mt-0.5"
  }, "Gain / Loss Ratio")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-[10px] pt-1.5 border-t border-binance-border/60 text-slate-400"
  }, /*#__PURE__*/React.createElement("span", null, "Avg W: ", /*#__PURE__*/React.createElement("b", {
    className: "text-binance-green"
  }, "$", formatPrice(stats.avgWin))), /*#__PURE__*/React.createElement("span", null, "Avg L: ", /*#__PURE__*/React.createElement("b", {
    className: "text-binance-red"
  }, "$", formatPrice(stats.avgLoss))))), /*#__PURE__*/React.createElement("div", {
    className: "p-3.5 bg-binance-panel border border-binance-border rounded-xl shadow flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-slate-400 text-[10px] font-bold uppercase tracking-wider"
  }, /*#__PURE__*/React.createElement("span", null, "TỔNG SỐ LỆNH"), /*#__PURE__*/React.createElement("span", null, "📊")), /*#__PURE__*/React.createElement("div", {
    className: "my-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-lg md:text-xl font-black text-slate-100"
  }, stats.total + stats.activeCount), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400 block mt-0.5"
  }, stats.activeCount, " đang mở • ", stats.total, " đã đóng")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-[10px] pt-1.5 border-t border-binance-border/60 text-slate-400"
  }, /*#__PURE__*/React.createElement("span", null, "Phí: ", /*#__PURE__*/React.createElement("b", null, "$", formatPrice(stats.totalFees))), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-cyan"
  }, "⚡ 24/7 Bot"))), /*#__PURE__*/React.createElement("div", {
    className: "p-3.5 bg-binance-panel border border-binance-border rounded-xl shadow flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-slate-400 text-[10px] font-bold uppercase tracking-wider"
  }, /*#__PURE__*/React.createElement("span", null, "LONG VS SHORT"), /*#__PURE__*/React.createElement("span", null, "🔄")), /*#__PURE__*/React.createElement("div", {
    className: "my-1 flex flex-col gap-0.5 text-[11px]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-binance-green font-bold"
  }, "🟢 LONG (", stats.longCount, "):"), /*#__PURE__*/React.createElement("b", {
    className: stats.longPnl >= 0 ? 'text-binance-green' : 'text-binance-red'
  }, stats.longPnl >= 0 ? '+' : '', "$", formatPrice(stats.longPnl))), /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-binance-red font-bold"
  }, "🔴 SHORT (", stats.shortCount, "):"), /*#__PURE__*/React.createElement("b", {
    className: stats.shortPnl >= 0 ? 'text-binance-green' : 'text-binance-red'
  }, stats.shortPnl >= 0 ? '+' : '', "$", formatPrice(stats.shortPnl)))), /*#__PURE__*/React.createElement("div", {
    className: "text-[10px] pt-1 border-t border-binance-border/60 text-slate-400 text-center"
  }, "Phân bổ 2 chiều cân bằng")), /*#__PURE__*/React.createElement("div", {
    className: "p-3.5 bg-binance-panel border border-binance-border rounded-xl shadow flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-slate-400 text-[10px] font-bold uppercase tracking-wider"
  }, /*#__PURE__*/React.createElement("span", null, "BEST / WORST TRADE"), /*#__PURE__*/React.createElement("span", null, "🏆")), /*#__PURE__*/React.createElement("div", {
    className: "my-1 flex flex-col gap-0.5 text-[11px]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 truncate max-w-[50px]"
  }, stats.bestTrade?.symbol || 'N/A', ":"), /*#__PURE__*/React.createElement("b", {
    className: "text-binance-green"
  }, "+", formatPrice(stats.bestTrade?.net_pnl_usd || 0))), /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 truncate max-w-[50px]"
  }, stats.worstTrade?.symbol || 'N/A', ":"), /*#__PURE__*/React.createElement("b", {
    className: "text-binance-red"
  }, formatPrice(stats.worstTrade?.net_pnl_usd || 0)))), /*#__PURE__*/React.createElement("div", {
    className: "text-[10px] pt-1 border-t border-binance-border/60 text-slate-400 text-center"
  }, "Bảo toàn R:R kỷ luật"))), /*#__PURE__*/React.createElement("section", {
    className: "bg-binance-panel border border-binance-border rounded-xl p-4 md:p-5 flex flex-col gap-4 shadow-xl"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-binance-border pb-3.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-extrabold text-sm md:text-base text-white flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", null, "📅 LỊCH GIAO DỊCH & PNL THEO NGÀY"), /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-binance-yellow capitalize font-mono font-bold bg-binance-card px-2.5 py-0.5 rounded-lg border border-binance-border"
  }, monthName))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2 font-mono text-xs self-end sm:self-auto"
  }, selectedDateFilter && /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "✕ Đang lọc ngày ", selectedDateFilter)), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center bg-binance-card border border-binance-border rounded-lg p-0.5 gap-1"
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, "Hôm nay"), /*#__PURE__*/React.createElement("button", {
    className: "px-2.5 py-1 rounded hover:bg-binance-hover text-slate-300 font-bold transition",
    onClick: nextMonth,
    title: "Tháng sau"
  }, "▶")))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-7 gap-1.5 text-center font-mono font-bold text-[11px] text-slate-400"
  }, ['Thứ 2 (Mon)', 'Thứ 3 (Tue)', 'Thứ 4 (Wed)', 'Thứ 5 (Thu)', 'Thứ 6 (Fri)', 'Thứ 7 (Sat)', 'Chủ Nhật (Sun)'].map(d => /*#__PURE__*/React.createElement("div", {
    key: d,
    className: "py-1 bg-binance-subpanel/60 rounded border border-binance-border/50 text-[10.5px]"
    ...
    if (!cell.day) {
      return /*#__PURE__*/React.createElement("div", {
        key: `empty_${idx}`,
        className: "min-h-[72px] md:min-h-[84px] rounded-lg bg-slate-900/20 border border-slate-800/30 opacity-40"
      });
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: `text-xs font-bold ${hasTrades ? 'text-white' : 'text-slate-500'}`
    }, cell.day), hasTrades && /*#__PURE__*/React.createElement("span", {
      className: "text-[9.5px] px-1.5 py-0.2 rounded-full font-bold bg-black/50 border border-white/10 text-slate-300"
    }, cell.trades.length, " ", cell.trades.length === 1 ? 'lệnh' : 'lệnh')), hasTrades ? /*#__PURE__*/React.createElement("div", {
      className: "flex flex-col gap-0.5 mt-1 font-mono"
    }, /*#__PURE__*/React.createElement("span", {
      className: `text-xs md:text-sm tracking-tight ${pnlColor}`
    }, isProfit ? '+' : '', "$", formatPrice(cell.pnl)), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center justify-between text-[9px] text-slate-400"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-emerald-400 font-bold"
    }, cell.wins, "W"), /*#__PURE__*/React.createElement("span", {
      className: "text-rose-400 font-bold"
    }, cell.losses, "L"))) : /*#__PURE__*/React.createElement("div", {
      className: "text-[9.5px] text-slate-600 font-mono mt-2"
    }, "--"));
  }))), /*#__PURE__*/React.createElement("section", {
    className: "bg-binance-panel border border-binance-border rounded-xl flex flex-col overflow-hidden shadow-xl"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-4 border-b border-binance-border bg-binance-subpanel flex flex-col md:flex-row items-start md:items-center justify-between gap-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3 flex-wrap"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-extrabold text-sm text-white flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", null, "📋 BÁO CÁO CHI TIẾT TỪNG LỆNH & ENTRY"), /*#__PURE__*/React.createElement("span", {
    className: "bg-binance-yellow text-black text-xs px-2 py-0.5 rounded-full font-black font-mono"
  }, filteredTrades.length)), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center bg-binance-bg border border-binance-border rounded-lg p-0.5 gap-0.5 text-xs font-mono"
  }, [{
    id: 'ALL',
    label: `Tất Cả (${trades.length})`
  }, {
    id: 'WIN',
    label: `🟢 Thắng (${stats.wins})`
  }, {
    id: 'LOSS',
    label: `🔴 Thua (${stats.losses})`
  }, {
    id: 'ACTIVE',
    label: `⚡ Đang Mở (${stats.activeCount})`
    ...
    className: "bg-[#0B0E17] text-slate-400 sticky top-0 z-10 border-b border-binance-border uppercase text-[10px] tracking-wider"
    ...
    className: "py-2.5 px-3"
  }, "Entry → Exit Price"), /*#__PURE__*/React.createElement("th", {
    className: "py-2.5 px-3"
  }, "Quy Mô / Vốn"), /*#__PURE__*/React.createElement("th", {
    className: "py-2.5 px-3"
  }, "Lợi Nhuận (PnL)"), /*#__PURE__*/React.createElement("th", {
    className: "py-2.5 px-3"
  }, "Kết Quả"), /*#__PURE__*/React.createElement("th", {
    className: "py-2.5 px-3"
  }, "Chiến Lược & Rationale"), /*#__PURE__*/React.createElement("th", {
    className: "py-2.5 px-3"
    ...
    className: "animate-spin inline-block mr-2 text-base"
  }, "⚡"), "Đang tải dữ liệu nhật ký giao dịch...")) : filteredTrades.length === 0 ? /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
    colSpan: "10",
    className: "py-12 text-center text-slate-400"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-2xl block mb-1"
  }, "📭"), "Không có giao dịch nào khớp với bộ lọc hiện tại.")) : filteredTrades.map(trade => {
    ...
    }, trade.open_time ? new Date(trade.open_time).toLocaleDateString() : '--'), /*#__PURE__*/React.createElement("span", {
      className: "text-[10px] text-slate-400"
    }, trade.open_time ? new Date(trade.open_time).toLocaleTimeString() : '')), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 whitespace-nowrap"
    }, /*#__PURE__*/React.createElement("span", {
      className: "font-extrabold text-white text-xs block"
    }, trade.symbol), /*#__PURE__*/React.createElement("span", {
      className: "text-[9.5px] bg-binance-card px-1.5 py-0.2 rounded border border-binance-borderSubtle font-bold text-binance-textSec"
    }, trade.exchange || 'BINANCE')), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 whitespace-nowrap"
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-1.5"
    }, /*#__PURE__*/React.createElement("span", {
      className: `px-2 py-0.5 rounded font-extrabold text-[10px] ${isLong ? 'bg-binance-green/20 text-binance-green border border-binance-green/40' : 'bg-binance-red/20 text-binance-red border border-binance-red/40'}`
    }, isLong ? '▲ LONG' : '▼ SHORT'), /*#__PURE__*/React.createElement("span", {
      className: "text-[10px] text-binance-yellow font-bold bg-binance-bg px-1.5 py-0.5 rounded border border-binance-border"
    }, trade.leverage || 20, "x"))), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 whitespace-nowrap"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-white font-bold block"
    }, "$", formatPrice(trade.entry_price)), /*#__PURE__*/React.createElement("span", {
      className: "text-[10px] text-slate-400"
    }, "→ ", isActive ? /*#__PURE__*/React.createElement("b", {
      className: "text-binance-yellowHover"
    }, "$", formatPrice(trade.current_price || trade.entry_price), " (Live)") : `$${formatPrice(trade.exit_price || trade.current_price || trade.entry_price)}`)), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 whitespace-nowrap"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-white block font-bold"
    }, "$", formatPrice(trade.pos_size_usd)), /*#__PURE__*/React.createElement("span", {
      className: "text-[10px] text-slate-400"
    }, "Ký quỹ: $", formatPrice(trade.initial_margin))), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 whitespace-nowrap"
    }, /*#__PURE__*/React.createElement("span", {
      className: `font-black text-xs block ${isActive ? pnl >= 0 ? 'text-binance-green' : 'text-binance-red' : isWin ? 'text-binance-green' : isLoss ? 'text-binance-red' : 'text-slate-300'}`
    }, pnl >= 0 ? '+' : '', "$", formatPrice(pnl)), /*#__PURE__*/React.createElement("span", {
      className: "text-[10px] text-slate-400"
    }, trade.roe_pct !== undefined ? `${trade.roe_pct >= 0 ? '+' : ''}${Number(trade.roe_pct).toFixed(2)}% ROE` : '')), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 whitespace-nowrap"
    }, isActive ? /*#__PURE__*/React.createElement("span", {
      className: "bg-binance-cyan/20 text-binance-cyan border border-binance-cyan/40 px-2 py-0.5 rounded-full font-bold text-[10px]"
    }, "⚡ Đang Chạy") : isWin ? /*#__PURE__*/React.createElement("span", {
      className: "bg-emerald-950 text-emerald-400 border border-emerald-600/50 px-2 py-0.5 rounded-full font-bold text-[10px]"
    }, "✓ ", trade.exit_reason || trade.status || 'Chốt Lãi') : /*#__PURE__*/React.createElement("span", {
      className: "bg-rose-950 text-rose-400 border border-rose-600/50 px-2 py-0.5 rounded-full font-bold text-[10px]"
    }, "✕ ", trade.exit_reason || trade.status || 'Dừng Lỗ')), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 max-w-[200px] truncate"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-slate-200 block font-bold truncate"
    }, trade.strategy_name || 'STAT2 Box Strategy'), /*#__PURE__*/React.createElement("span", {
      className: "text-[10px] text-slate-400 truncate block"
    }, trade.entry_rationale || trade.market_regime || 'SMC Liquidity & FVG Retest')), /*#__PURE__*/React.createElement("td", {
      className: "py-2.5 px-3 max-w-[160px] truncate text-slate-300"
    }, trade.notes ? /*#__PURE__*/React.createElement("span", {
      className: "text-binance-yellow bg-binance-yellow/10 border border-binance-yellow/30 px-2 py-0.5 rounded text-[10px] block truncate"
    }, "📝 ", trade.notes) : /*#__PURE__*/React.createElement("span", {
      className: "text-slate-600 italic text-[10px]"
    }, "(Chưa có)")), /*#__PURE__*/React.createElement("td", {
  ...
  })))))), isJsonModalOpen && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-60 bg-black/80 backdrop-blur-md flex items-center justify-center p-4",
    onClick: () => setIsJsonModalOpen(false)
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-[#0B0E17] border border-binance-borderHighlight rounded-xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden shadow-2xl",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-3.5 border-b border-binance-border bg-[#0D111C] flex items-center justify-between font-mono"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-extrabold text-sm text-binance-yellow flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", null, "📄 TRADING JOURNAL RAW JSON REPORT"), /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-slate-400"
  }, "(", trades.length, " Trades)")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    ...
    onClick: handleExportJson
  }, "📥 Tải File JSON"), /*#__PURE__*/React.createElement("button", {
    ...
    className: "flex-1 p-4 overflow-auto bg-[#07090F] font-mono text-[11px] text-emerald-400 leading-relaxed select-text"
  }, /*#__PURE__*/React.createElement("pre", null, JSON.stringify(fullJsonReport, null, 2))))));
}
...
function SetupWizardModal({
  ...
  const handleExecuteWizard = async () => {
    ...
    try {
      ...
      if (res.success) {
        setApplyLogs(prev => [...prev, '🔄 [AUTO-REBOOT] Đang tự động khởi động lại dịch vụ máy chủ, nạp lại cấu hình SQLite và đồng bộ giá WebSocket 6 sàn...', '🎉 THIẾT LẬP HOÀN TẤT THÀNH CÔNG! Máy chủ đã áp dụng toàn bộ cấu hình mới và Scanner 24/7 đang chạy.']);
        setIsSuccess(true);
        setTimeout(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "bg-[#0B0E17] border border-binance-borderHighlight rounded-xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-extrabold text-sm sm:text-base text-white block"
  }, "TRÌNH HƯỚNG DẪN CÀI ĐẶT MỚI (SETUP WIZARD)"), /*#__PURE__*/React.createElement("span", {
    className: "text-[10.5px] text-slate-400"
  }, "Khởi tạo SQLite, Quản lý rủi ro 1% và Kích hoạt 6 Sàn Phái Sinh"))), /*#__PURE__*/React.createElement("button", {
    className: "text-slate-400 hover:text-white text-base w-7 h-7 rounded bg-binance-subpanel flex items-center justify-center",
    onClick: onClose
  }, "✕")), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-4 border-b border-binance-border bg-[#080B11] text-[11px] font-mono text-center"
  }, [{
    num: 1,
    label: '1. DB & Vốn'
  }, {
    ...
    className: "p-4 sm:p-6 overflow-y-auto flex-1 flex flex-col gap-4 text-xs font-mono"
  ...
  }, "Khởi Tạo Cơ Sở Dữ Liệu SQLite & Cấu Trúc Bảng"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-[11px] leading-relaxed"
  }, "Hệ thống sẽ tự động khởi tạo các bảng `trade_positions`, `whitelist_symbols`, `symbol_strategies`, `chart_drawings`, `order_notes` với chuẩn SQLite WAL Mode tối ưu hóa ghi nhanh 60 FPS."))), /*#__PURE__*/React.createElement("div", {
    className: "p-4 bg-[#111726] rounded-lg border border-binance-border flex flex-col gap-3"
  }, /*#__PURE__*/React.createElement("label", {
    ...
    className: "text-white"
  }, "Làm sạch & Tạo mới toàn bộ dữ liệu bảng SQLite (Clean Reset)"), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[10px] block"
  }, "Xóa dữ liệu cũ, đặt lại các bảng về trạng thái xuất xưởng sạch sẽ."))), /*#__PURE__*/React.createElement("div", {
    className: "pt-2 border-t border-binance-border/60 flex flex-col gap-2"
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-slate-300 font-bold"
  }, "Số Dư Vốn Ban Đầu Khởi Tạo ($ Wallet Balance):"), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, [500, 1000, 2000, 5000, 10000].map(val => /*#__PURE__*/React.createElement("button", {
    key: val,
    type: "button",
  ...
  }, "Hoặc nhập tùy chọn:"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    ...
    className: "text-slate-400"
  }, "USD"))))), step === 2 && /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-binance-card rounded-lg border border-binance-border flex items-start gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "text-white text-sm block mb-1"
  }, "Cấu Hình Mô Hình Quản Trị Rủi Ro & Kích Thước Vị Thế (Money Management)"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-[11px] leading-relaxed"
  }, "Hệ thống tính Size lệnh theo mô hình ", /*#__PURE__*/React.createElement("b", null, "Fixed Fractional Risk Model"), ". Tự động chia nhỏ lệnh chốt lời TP1 (chốt 50%), dời Stop Loss về hòa vốn (Auto Breakeven) và chốt lời TP2."))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 sm:grid-cols-2 gap-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-[#111726] rounded-lg border border-binance-border flex flex-col gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-binance-yellow font-bold"
  }, "% Rủi Ro Mỗi Lệnh (Risk Per Trade):"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-4 gap-1.5"
  }, [0.5, 1.0, 1.5, 2.0].map(r => /*#__PURE__*/React.createElement("button", {
    key: r,
    type: "button",
    ...
    className: "text-white font-bold"
  }, "Đòn Bẩy & Ký Quỹ (Leverage & Margin):"), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, [10, 20, 50].map(lev => /*#__PURE__*/React.createElement("button", {
    key: lev,
    type: "button",
  ...
  }, lev, "x")), /*#__PURE__*/React.createElement("select", {
    value: marginMode,
    ...
    value: "ISOLATED"
  }, "ISOLATED"), /*#__PURE__*/React.createElement("option", {
    value: "CROSSED"
  }, "CROSSED"))), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400"
  }, "Isolated Margin giúp cách ly hoàn toàn rủi ro từng lệnh.")), /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-[#111726] rounded-lg border border-binance-border flex flex-col gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-binance-green font-bold"
  }, "Take Profit 1 (TP1) & Auto Breakeven:"), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[11px]"
  }, "Tỷ lệ TP1:"), /*#__PURE__*/React.createElement("select", {
    value: tp1Ratio,
    onChange: e => setTp1Ratio(parseFloat(e.target.value)),
    className: "bg-[#090D16] border border-binance-border rounded px-2 py-1 text-white font-bold focus:outline-none"
  }, /*#__PURE__*/React.createElement("option", {
    value: "1.0"
  }, "1.0R"), /*#__PURE__*/React.createElement("option", {
    value: "1.5"
  }, "1.5R (Chuẩn)"), /*#__PURE__*/React.createElement("option", {
    value: "2.0"
  }, "2.0R")), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[11px]"
  }, "Đóng:"), /*#__PURE__*/React.createElement("span", {
    className: "text-white font-bold"
  ...
  }, "Tự động dời SL về hòa vốn (+0.05% phí) ngay khi khớp TP1"))), /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-[#111726] rounded-lg border border-binance-border flex flex-col gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-binance-cyan font-bold"
  }, "Take Profit 2 (TP2) & Giới Hạn Lệnh:"), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[11px]"
  }, "Tỷ lệ TP2:"), /*#__PURE__*/React.createElement("select", {
    value: tp2Ratio,
    onChange: e => setTp2Ratio(parseFloat(e.target.value)),
    className: "bg-[#090D16] border border-binance-border rounded px-2 py-1 text-white font-bold focus:outline-none"
  }, /*#__PURE__*/React.createElement("option", {
    value: "2.5"
  }, "2.5R"), /*#__PURE__*/React.createElement("option", {
    value: "3.0"
  }, "3.0R (Chuẩn)"), /*#__PURE__*/React.createElement("option", {
    value: "4.0"
  }, "4.0R"))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2 mt-1"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[11px]"
  }, "Tối đa lệnh mở cùng lúc:"), /*#__PURE__*/React.createElement("select", {
    value: maxConcurrentPositions,
    onChange: e => setMaxConcurrentPositions(parseInt(e.target.value)),
    className: "bg-[#090D16] border border-binance-border rounded px-2 py-1 text-white font-bold focus:outline-none"
  }, /*#__PURE__*/React.createElement("option", {
    value: "3"
  }, "3 lệnh (3% rủi ro)"), /*#__PURE__*/React.createElement("option", {
    value: "5"
  }, "5 lệnh (5% rủi ro)"), /*#__PURE__*/React.createElement("option", {
    value: "10"
  }, "10 lệnh (10% rủi ro)")))))), step === 3 && /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-binance-card rounded-lg border border-binance-border flex items-start gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "text-white text-sm block mb-1"
  }, "Xác Nhận Cấu Hình & Khởi Chạy Hệ Thống"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-[11px] leading-relaxed"
  }, "Kiểm tra lại toàn bộ thông số đã thiết lập trước khi áp dụng vào cơ sở dữ liệu SQLite và khởi động hệ thống."))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 sm:grid-cols-4 gap-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 bg-[#111726] rounded border border-binance-border"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[10px] block font-bold"
  }, "VỐN KHỞI TẠO:"), /*#__PURE__*/React.createElement("span", {
    className: "text-white font-extrabold text-base"
  }, "$", Number(initialBalance).toLocaleString())), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 bg-[#111726] rounded border border-binance-border"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[10px] block font-bold"
  }, "MỨC RỦI RO:"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-yellow font-extrabold text-base"
  }, riskPct, "% / Lệnh")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 bg-[#111726] rounded border border-binance-border"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[10px] block font-bold"
  }, "SL / TP1 / TP2:"), /*#__PURE__*/React.createElement("span", {
    className: "text-emerald-400 font-extrabold text-xs"
  }, "TP1: ", tp1Ratio, "R | TP2: ", tp2Ratio, "R")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 bg-[#111726] rounded border border-binance-border"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400 text-[10px] block font-bold"
  }, "SÀN KÍCH HOẠT:"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-cyan font-extrabold text-base"
  }, activeExchangesList.length, " Sàn"))), applyLogs.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-[#080B11] rounded-lg border border-binance-border font-mono text-[11px] flex flex-col gap-1 max-h-40 overflow-y-auto"
  }, applyLogs.map((log, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    className: "text-emerald-400"
  }, log))), !isSuccess && /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, isApplying ? '⏳ Đang Thiết Lập Hệ Thống...' : '🚀 ÁP DỤNG CÀI ĐẶT & KHỞI CHẠY HỆ THỐNG')))), /*#__PURE__*/React.createElement("div", {
    ...
    onClick: onClose
  }, "Hủy"), step < 4 ? /*#__PURE__*/React.createElement("button", {
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SplashScreen, {
    ...
    className: "hidden sm:inline"
  }, "Livestream Tracker"), /*#__PURE__*/React.createElement("span", {
    className: "sm:hidden"
    ...
    className: "hidden sm:inline"
  }, "Trading Journal")), /*#__PURE__*/React.createElement("button", {
    ...
    className: "text-binance-yellow font-bold"
  }, "🌐 Multi-Exchange Engine & CCXT Pro Ingestion (90% Perps)"), /*#__PURE__*/React.createElement("button", {
    ...
    onClick: () => fetch('/api/admin/import-all-exchanges', {
      method: 'POST'
    }).then(() => alert('Bắt đầu đồng bộ 90% symbol perpetual của tất cả 6 sàn qua CCXT Pro!'))
  }, /*#__PURE__*/React.createElement("span", null, "⚡"), /*#__PURE__*/React.createElement("span", null, "Đồng Bộ Toàn Bộ 6 Sàn (90% Perps)"))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 md:grid-cols-3 gap-2"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-binance-textSec text-[10px]"
  }, countBinance, " Symbols • 90% Perps"), /*#__PURE__*/React.createElement("button", {
    ...
    onClick: () => fetch('/api/admin/import-binance', {
      method: 'POST'
    }).then(() => alert('Binance 90% perpetual seeding started.'))
  }, "⚡ Re-Seed Binance (90%)")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 rounded bg-binance-card border border-binance-border flex flex-col gap-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-white"
  }, "⬛ Bybit Linear"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-textSec text-[10px]"
  }, countBybit, " Symbols • 90% Perps"), /*#__PURE__*/React.createElement("button", {
    className: "bg-binance-subpanel hover:bg-binance-hover px-2 py-1 rounded text-[10px] font-bold border border-binance-border mt-1",
    onClick: () => fetch('/api/admin/import-bybit', {
      method: 'POST'
    }).then(() => alert('Bybit 90% perpetual seeding started.'))
  }, "⚡ Re-Seed Bybit (90%)")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 rounded bg-binance-card border border-binance-border flex flex-col gap-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-white"
  }, "🔷 OKX Perpetual"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-textSec text-[10px]"
  }, countOkx, " Symbols • 90% Perps"), /*#__PURE__*/React.createElement("button", {
    className: "bg-binance-subpanel hover:bg-binance-hover px-2 py-1 rounded text-[10px] font-bold border border-binance-border mt-1",
    onClick: () => fetch('/api/admin/import-okx', {
      method: 'POST'
    }).then(() => alert('OKX 90% perpetual seeding started.'))
  }, "⚡ Re-Seed OKX (90%)")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 rounded bg-binance-card border border-binance-border flex flex-col gap-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-white"
  }, "🔵 Bitget Perpetual"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-textSec text-[10px]"
  }, countBitget, " Symbols • 90% Perps"), /*#__PURE__*/React.createElement("button", {
    className: "bg-binance-subpanel hover:bg-binance-hover px-2 py-1 rounded text-[10px] font-bold border border-binance-border mt-1",
    onClick: () => fetch('/api/admin/import-bitget', {
      method: 'POST'
    }).then(() => alert('Bitget 90% perpetual seeding started.'))
  }, "⚡ Re-Seed Bitget (90%)")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 rounded bg-binance-card border border-binance-border flex flex-col gap-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-white"
  }, "🚪 Gate.io Perpetual"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-textSec text-[10px]"
  }, countGate, " Symbols • 90% Perps"), /*#__PURE__*/React.createElement("button", {
    className: "bg-binance-subpanel hover:bg-binance-hover px-2 py-1 rounded text-[10px] font-bold border border-binance-border mt-1",
    onClick: () => fetch('/api/admin/import-gate', {
      method: 'POST'
    }).then(() => alert('Gate.io 90% perpetual seeding started.'))
  }, "⚡ Re-Seed Gate (90%)")), /*#__PURE__*/React.createElement("div", {
    className: "p-2.5 rounded bg-binance-card border border-binance-border flex flex-col gap-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-bold text-white"
  }, "💠 BingX Perpetual"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-textSec text-[10px]"
  }, countBingx, " Symbols • 90% Perps"), /*#__PURE__*/React.createElement("button", {
    className: "bg-binance-subpanel hover:bg-binance-hover px-2 py-1 rounded text-[10px] font-bold border border-binance-border mt-1",
    onClick: () => fetch('/api/admin/import-bingx', {
      method: 'POST'
    }).then(() => alert('BingX 90% perpetual seeding started.'))
  }, "⚡ Re-Seed BingX (90%)")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    ...
    className: "border border-binance-yellow/30 bg-binance-yellow/5 rounded p-3 flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("b", {
    className: "text-binance-yellow block"
  }, "🧙‍♂️ Trình Cài Đặt Mới Hệ Thống (Setup Wizard)"), /*#__PURE__*/React.createElement("span", {
    className: "text-binance-textSec text-[10px]"
  }, "Cài đặt lại từ đầu: Khởi tạo bảng SQLite, cấu hình quản trị rủi ro & kích hoạt 6 sàn.")), /*#__PURE__*/React.createElement("button", {
  ...
  }, "✨ Mở Setup Wizard")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-binance-textSec text-[10px]"
  }, "Wipe order positions or perform full factory reload for 6 exchanges.")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, "Save Settings")))), isJournalOpen && /*#__PURE__*/React.createElement(TradingJournalModal, {
  ...
  }), isWizardOpen && /*#__PURE__*/React.createElement(SetupWizardModal, {
    isOpen: isWizardOpen,
